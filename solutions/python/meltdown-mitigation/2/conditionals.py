...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    neutrons_x_temperature = neutrons_emitted * temperature

    if temperature < 800 and neutrons_emitted > 500 and neutrons_x_temperature < 500000:
        return True
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    temperature_x_neutrons_per_second = temperature * neutrons_produced_per_second
    low = temperature_x_neutrons_per_second < threshold * 0.9
    normal = threshold + (threshold * 0.1) >= temperature_x_neutrons_per_second >= threshold - (threshold * 0.1)
