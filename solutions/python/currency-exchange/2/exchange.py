...
Script to simply convert currencies
"""
...
def get_number_of_bills(budget, denomination):
    ...
    return floor(int(budget / denomination))
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    current_budget = exchange_money(budget, real_exchange_rate)
    real_number_of_bills = get_number_of_bills(current_budget, denomination)

    return denomination * real_number_of_bills
